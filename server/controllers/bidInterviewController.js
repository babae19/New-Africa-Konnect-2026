...
const scheduleInterview = async (req, res) => {
    try {
        ...
        const { scheduledTime, duration, clientNotes } = req.body;
        ...
        const meetingLink = createMeetingRoom({ projectId, purpose: 'bid-interview' }).meetingLink;
        const meetingPlatform = 'Jitsi Meet';
...
const updateInterview = async (req, res) => {
    try {
        ...
        const { scheduledTime, duration, status, outcome } = req.body;
        ...
        const updatedInterview = await updateBidInterview(interviewId, {
            scheduledTime,
            duration,
            // Links are generated by the server, never overwritten by a caller.
