...
const notificationMessages = {
    ...
    project_application_received: data => `${data.expertName || 'An expert'} applied to ${data.projectTitle}`,
    application_accepted: data => `Your application${data.projectTitle ? ` for ${data.projectTitle}` : ''} was accepted`,
    application_shortlisted: data => `Your application${data.projectTitle ? ` for ${data.projectTitle}` : ''} was shortlisted`,
    application_rejected: data => `Your application${data.projectTitle ? ` for ${data.projectTitle}` : ''} was not selected`,
    interview_scheduled: data => `Interview scheduled for ${data.projectTitle}`,
